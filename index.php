...
<head>
    ...
    <meta name="description" content="Kharigo Tech - Your Partner in Web Development and Technology Solutions">
    <title>Kharigo Tech - Web Development & IT Solutions</title>
    <meta name="description" content="Kharigo Tech is your partner in web development and IT solutions. We specialize in creating cutting-edge websites, web applications, and more.">

    <meta property="og:title" content="Kharigo Tech - Web Development & IT Solutions">
    <meta property="og:description" content="Kharigo Tech is your partner in web development and IT solutions. We specialize in creating cutting-edge websites, web applications, and more.">
    ...
    <meta property="og:url" content="https://www.kharigo.com/tech/">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Kharigo Tech">

    <link rel="icon" href="https://www.kharigo.com/public/web_images/favicon_128px.ico">
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "Organization",
            "url": "https://www.kharigo.com",
            "logo": "https://www.kharigo.com/public/web_images/logo_250px.png"
        }
    </script>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg  ">
        <div class="container">
            <b>
                <a class="navbar-brand" href="#">Kharigo</a>
            </b>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="https://kharigo.com/Tools/Image_compress/">Image compress</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" target="_blank" href="https://www.kharigo.com/wholesale">Wholesale</a></li>
                            <!-- <li><a class="dropdown-item" href="#">Another action</a></li>
                            <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                        </ul>
                    </li>
