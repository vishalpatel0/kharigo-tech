<?php
$page_tital = "Kharigo Tech -   Website Development Standard Plan for Medium Business";
$page_description = "Kharigo Tech is Elevate your website with captivating content that resonates with your audience. Our Content Creation Add-On, starting from ₹5,000, includes expertly crafted text and engaging visuals that tell your brand's story effectively.";
?>
...
<div class="content" id="content">
    ...
    <div class="container my-5 ">
        ...
        <div class="tital">
            <h1>Maintenance and Service Plans</h1>
        </div>
        <div class="row">
